    ...
    toolbarContainer.innerHTML = `
      <div id="blur-toolbar">
        ...
        <div id="toolbar-tabs" style="display: flex; gap: 2px; border-right: 1px solid rgba(0,0,0,0.1); padding-right: 8px; margin-right: 8px;">
          <button class="toolbar-tab active" data-tab="select" title="Selection Tools">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              <path d="M11.4 12.8C11.35 13 11.26 13 11.19 12.85L8.9 8.45C8.83 8.3 8.93 8.21 9.08 8.27L13.48 10.55C13.63 10.62 13.61 10.71 13.41 10.77L11.85 11.18Z" stroke="currentColor" stroke-width="1" fill="none"/>
            </svg>
          </button>
          <button class="toolbar-tab" data-tab="effects" title="Effects">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          ...
          <button class="toolbar-tab" data-tab="file" title="Save/Export">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              <path d="M3 2H13L14 5V13C14 13.55 13.55 14 13 14H3C2.45 14 2 13.55 2 13V3C2 2.45 2.45 2 3 2Z" stroke="currentColor" stroke-width="1.5" fill="none"/>
            </svg>
          </button>
        </div>
        ...
        <div id="toolbar-content" style="display: flex; gap: 4px; align-items: center; flex: 1;">
          ...
          <!-- EFFECTS TAB -->
          <div class="toolbar-panel" data-panel="effects" style="display: none; gap: 4px; align-items: center;">
          ...
          <!-- FILE TAB -->
          <div class="toolbar-panel" data-panel="file" style="display: none; gap: 4px; align-items: center;">
        ...
        <div style="display: flex; gap: 4px; align-items: center; border-left: 1px solid rgba(0,0,0,0.1); padding-left: 8px; margin-left: 8px;">
